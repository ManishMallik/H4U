      ...
      <View style={{paddingRight: 20}}></View>
        <TouchableOpacity style={styles.button} onPress={() => {
          ...
          {         
            ...
            //console.log(User.personalGoals[props.num-1].boxState);
          }
          else
          {
            setCheck("square-o");
            ...
            //console.log(User.personalGoals[props.num-1].boxState);
            //User.personalGoals[props.id-1].boxState = "square-o";
          }
...
const IncompleteGoals = ({navigation}) =>{
